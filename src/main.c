...
/**
  ...
  ******************************************************************************
  */
/*export PATH=$PATH:/Users/shenzi/Library/Python/3.9/bin && cd /Users/shenzi/Code/empty_h7 */
...
extern SPI_HandleTypeDef hspi6; // SPI6句柄声明，防止链接错误
